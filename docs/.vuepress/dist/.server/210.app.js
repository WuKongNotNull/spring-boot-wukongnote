        ...
        default: (0,external_vue_.withCtx)((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            if ((0,external_vue_.unref)(siteBrandLogo)) {
              _push2(`<img class="logo"${(0,server_renderer.ssrRenderAttr)("src", (0,external_vue_.unref)(lib/* withBase */.pJ)((0,external_vue_.unref)(siteBrandLogo)))}${(0,server_renderer.ssrRenderAttr)("alt", (0,external_vue_.unref)(siteBrandTitle))}${_scopeId}>`);
            } else {
              _push2(`<!---->`);
            }
...
;
//# sourceMappingURL=210.app.js.map