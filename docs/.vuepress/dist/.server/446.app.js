...
const data = {
  ...
  "headers": [
      ...
      "children": [
        {
          ...
          "slug": "spring-boot-是什么",
          "children": []
        },
        {
          "level": 3,
          "title": "Spring Boot 优点",
          "slug": "spring-boot-优点",
          "children": []
        },
        {
          "level": 3,
          "title": "Spring Boot 应用场景",
          "slug": "spring-boot-应用场景",
          "children": []
        }
      ]
    },
    {
      "level": 2,
      "title": "Spring Initialzr 构建项目",
      "slug": "spring-initialzr-构建项目",
      "children": [
        {
          "level": 3,
          "title": "悟空编号",
        ...
        {
          "level": 3,
          "title": "使用Spring Initialzr方式构建 Spring Boot 项目",
          "slug": "使用spring-initialzr方式构建-spring-boot-项目",
          "children": []
        }
      ]
    },
    ...
    },
    {
      ...
      "children": [
        ...
        {
          "level": 3,
          "title": "controller层单元测试",
          "slug": "controller层单元测试",
          "children": []
        }
      ]
    },
    ...
    {
      "level": 2,
      "title": "Spring Boot 执行流程",
      "slug": "spring-boot-执行流程",
      "children": []
    }
  ],
  "filePathRelative": "qt/README.md",
  "git": {
...
;// CONCATENATED MODULE: ./node_modules/vue-loader/dist/templateLoader.js??ruleSet[1].rules[2]!./node_modules/@vuepress/bundler-webpack/lib/build/ssr/vuepressLoader.js!./node_modules/vue-loader/dist/index.js??ruleSet[0].use[1]!./docs/.vuepress/.temp/pages/qt/index.html.vue?vue&type=template&id=13e12531


function ssrRender(_ctx, _push, _parent, _attrs) {
  _push(`<!--[--><h1 id="spring-boot-开发入门" tabindex="-1"><a class="header-anchor" href="#spring-boot-开发入门" aria-hidden="true">#</a> Spring Boot 开发入门</h1><h2 id="spring-boot" tabindex="-1"><a class="header-anchor" href="#spring-boot" aria-hidden="true">#</a> Spring Boot</h2><h3 id="spring-boot-是什么" tabindex="-1"><a class="header-anchor" href="#spring-boot-是什么" aria-hidden="true">#</a> Spring Boot 是什么</h3><h3 id="spring-boot-优点" tabindex="-1"><a class="header-anchor" href="#spring-boot-优点" aria-hidden="true">#</a> Spring Boot 优点</h3><ul><li>快速构建项目</li><li>内嵌服务器（Tomcat,Jetty,Undertow），无需部署 <code>war</code> 包</li><li>依赖启动器简化构建配置</li><li>自动化配置</li><li>整合大量第三方</li></ul><h3 id="spring-boot-应用场景" tabindex="-1"><a class="header-anchor" href="#spring-boot-应用场景" aria-hidden="true">#</a> Spring Boot 应用场景</h3><h2 id="spring-initialzr-构建项目" tabindex="-1"><a class="header-anchor" href="#spring-initialzr-构建项目" aria-hidden="true">#</a> Spring Initialzr 构建项目</h2><h3 id="悟空编号" tabindex="-1"><a class="header-anchor" href="#悟空编号" aria-hidden="true">#</a> 悟空编号</h3><p><code>sbqt001</code></p><br><h3 id="配套视频" tabindex="-1"><a class="header-anchor" href="#配套视频" aria-hidden="true">#</a> 配套视频</h3><blockquote><p>B 站链接：</p></blockquote><br><h3 id="使用spring-initialzr方式构建-spring-boot-项目" tabindex="-1"><a class="header-anchor" href="#使用spring-initialzr方式构建-spring-boot-项目" aria-hidden="true">#</a> 使用Spring Initialzr方式构建 Spring Boot 项目</h3><blockquote><ul><li><p>推荐：建议创建父子项目，而不是单体项目</p></li><li><p>推荐： 使用阿里 Maven 镜像构建项目，速度快</p><ul><li><p>打开 maven 的配置文件 <strong>conf/settings.xml</strong>，在 <code>&lt;mirrors&gt;&lt;/mirrors&gt;</code> 标签中添加 mirror 子节点:</p><div class="language-xml ext-xml line-numbers-mode"><pre class="language-xml"><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>mirror</span><span class="token punctuation">&gt;</span></span>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br></div></div></li></ul></li></ul></blockquote><h4 id="创建父项目" tabindex="-1"><a class="header-anchor" href="#创建父项目" aria-hidden="true">#</a> 创建父项目</h4><h4 id="创建子项目" tabindex="-1"><a class="header-anchor" href="#创建子项目" aria-hidden="true">#</a> 创建子项目</h4><p>第 1 步</p><img src="https://tva1.sinaimg.cn/large/008i3skNgy1gv5vwz27ifj61680u079e02.jpg" alt="image-20210711220609209" style="${
    (0,server_renderer.ssrRenderStyle)({"zoom":"50%"})
  }"><p>第 2 步</p><img src="https://tva1.sinaimg.cn/large/008i3skNgy1gv5vx513qbj60x80u041602.jpg" alt="image-20210711220906588" style="${
    (0,server_renderer.ssrRenderStyle)({"zoom":"50%"})
  }"><p>第 3 步</p><p>检查目录结构是否完整</p><blockquote><p>.mvn HELP.md mvnw mvnw.cmd 4 个文件（目录）可以直接删除</p></blockquote><img src="https://tva1.sinaimg.cn/large/008i3skNgy1gv5vxab95oj60pu0qajtp02.jpg" alt="image-20210711221204520" style="${
    (0,server_renderer.ssrRenderStyle)({"zoom":"50%"})
  }"><h2 id="启动banner图标设置" tabindex="-1"><a class="header-anchor" href="#启动banner图标设置" aria-hidden="true">#</a> 启动Banner图标设置</h2><h3 id="悟空编号-1" tabindex="-1"><a class="header-anchor" href="#悟空编号-1" aria-hidden="true">#</a> 悟空编号</h3><p><code>sbqt002</code></p><br><h3 id="配套视频-1" tabindex="-1"><a class="header-anchor" href="#配套视频-1" aria-hidden="true">#</a> 配套视频</h3><blockquote><p>B 站链接：</p></blockquote><br><div class="language-text ext-text line-numbers-mode"><pre class="language-text"><code>introduction
...
<span class="token punctuation">}</span>
    ...
    (0,server_renderer.ssrRenderStyle)({"zoom":"50%"})
  }"><p><strong>第2步</strong></p><p>ctrl+shift+alt(option)+/ 打开界面</p><img src="https://tva1.sinaimg.cn/large/008i3skNgy1gv5w15dyqkj61950h0n3102.jpg" alt="1593073323230" style="${
    (0,server_renderer.ssrRenderStyle)({"zoom":"50%"})
  }"><h4 id="热部署测试" tabindex="-1"><a class="header-anchor" href="#热部署测试" aria-hidden="true">#</a> 热部署测试</h4><p>使用浏览器测试，不需要重复启动main方法</p><h2 id="依赖管理" tabindex="-1"><a class="header-anchor" href="#依赖管理" aria-hidden="true">#</a> 依赖管理</h2><h2 id="spring-boot-自动配置" tabindex="-1"><a class="header-anchor" href="#spring-boot-自动配置" aria-hidden="true">#</a> Spring Boot 自动配置</h2><h2 id="spring-boot-执行流程" tabindex="-1"><a class="header-anchor" href="#spring-boot-执行流程" aria-hidden="true">#</a> Spring Boot 执行流程</h2><img src="https://tva1.sinaimg.cn/large/008i3skNgy1gv5w9zcp71j61460lhtbs02.jpg" alt="1593074745488" style="${
    (0,server_renderer.ssrRenderStyle)({"zoom":"50%"})
  }"><!--]-->`)
}
;// CONCATENATED MODULE: ./docs/.vuepress/.temp/pages/qt/index.html.vue?vue&type=template&id=13e12531

// EXTERNAL MODULE: ./node_modules/vue-loader/dist/exportHelper.js
var exportHelper = __webpack_require__(3744);
;// CONCATENATED MODULE: ./docs/.vuepress/.temp/pages/qt/index.html.vue
...
;
//# sourceMappingURL=446.app.js.map